...
<template>
    <header class="header">
        <div class="header__bar">
            ...
            <nav class="header__nav header__nav--left">
                <a
                    ...
                    :class="{
                        'header__nav-link--active': isHome && activeLabelKey === link.labelKey,
                    }"
                    >{{ link.label }}</a
                >
            </nav>
        ...
        <div class="progress-bar" aria-hidden="true">
            <div v-if="isHome" class="progress-bar__fill" :style="{ width: `${progress}%` }" />
        </div>
    </header>
...
:global(.mobile-nav__link.router-link-active) {
    color: var(--text);
}
